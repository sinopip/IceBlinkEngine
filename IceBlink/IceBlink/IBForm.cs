...
namespace IceBlink
{
    public partial class IBForm : Form
    {
        ...
        private Color ibTitleForeColor;
        private Color ibTitleShadowColor;
        ...
        {
            loadHeaderImage(g);
            this.IBBorderInsideColor = g.module.ModuleTheme.IBBorderInsideColor;
            this.IBBorderMiddleColor = g.module.ModuleTheme.IBBorderMiddleColor;
            this.IBBorderOutsideColor = g.module.ModuleTheme.IBBorderOutsideColor;            
        }
        private void loadHeaderImage(Game game)
        {
            try
            {
                if (game.module != null)
                {
                    ...
                    {
                        this.pnlTitle.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleGroupBoxLargeImage);
                    }
                    else
                    {
                        this.pnlTitle.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\gb_lrg_header.png");
                    }
                }
                else
                {
