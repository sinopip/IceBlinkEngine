...
namespace IceBlink
{
   public  class IceBlinkButtonLarge : System.Windows.Forms.Button
    {
       //private Game game;
       ...
       public IceBlinkButtonLarge()
       {
           ...
           this.BackgroundImage = global::IceBlink.Properties.Resources.b_med_normal;
           ...
           this.HoverImage = global::IceBlink.Properties.Resources.b_med_hover;
           this.Name = "iceBlinkButtonLarge1";
           this.NormalImage = global::IceBlink.Properties.Resources.b_med_normal;
           this.PressedImage = global::IceBlink.Properties.Resources.b_med_pressed;
           this.Size = new System.Drawing.Size(140, 30);
           this.Text = "";
           this.TextIB = "iceBlinkButtonLarge1";
       ...
       private void loadButtonImages(Game game)
       {
           try
           {
               if (game.module != null)
               {
                   if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargeNormalImage))
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargeNormalImage);
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargeHoverImage);
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargeNormalImage);
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargePressedImage);
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonLargeDisabledImage);
                   }
                   else
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_lrg_normal.png");
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_lrg_hover.png");
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_lrg_normal.png");
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_lrg_pressed.png");
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_lrg_disabled.png");
                   }
               }
               else
               {
