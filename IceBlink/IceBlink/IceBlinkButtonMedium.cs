   ...
   public  class IceBlinkButtonMedium : System.Windows.Forms.Button
    {
       ...
       private void loadButtonImages(Game game)
       {
           try
           {
               if (game.module != null)
               {
                   if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumNormalImage))
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumNormalImage);
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumHoverImage);
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumNormalImage);
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumPressedImage);
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonMediumDisabledImage);
                   }
                   else
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_med_normal.png");
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_med_hover.png");
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_med_normal.png");
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_med_pressed.png");
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_med_disabled.png");
                   }
               }
               else
               {
