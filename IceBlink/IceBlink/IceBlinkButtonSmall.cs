           ...
           try
           {
               if (game.module != null)
               {
                   if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonSmallNormalImage))
                   {
                       ...
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonSmallDisabledImage);
                   }
                   else
                   {
                       ...
                       this.DisabledImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_sml_disabled.png");
                   }
               }
               else
               {
