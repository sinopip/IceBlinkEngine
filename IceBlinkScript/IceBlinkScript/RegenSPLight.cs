...
namespace IceBlink
{
    public class IceBlinkScript
    {
        public void Script(ScriptFunctions sf, string p1, string p2, string p3, string p4)
        {
            ...
            MessageBox.Show(name + "'s current spell points are " + sp.ToString());
            ...
            MessageBox.Show("now " + name + "'s current spell points are " + sf.gm.playerList.PCList[PCindex].SP.ToString());
