namespace IceBlinkToolset
{
    partial class SpriteEditor
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.btnDeathPlay = new System.Windows.Forms.Button();
        	this.numDeathNoF = new System.Windows.Forms.NumericUpDown();
        	this.numDeathFPS = new System.Windows.Forms.NumericUpDown();
        	...
        	((System.ComponentModel.ISupportInitialize)(this.numDeathNoF)).BeginInit();
        	((System.ComponentModel.ISupportInitialize)(this.numDeathFPS)).BeginInit();
        	...
        	this.numIdleDelay.Increment = new decimal(new int[] {
        	        	        	...
        	        	        	0,
        	        	        	0});
        	this.numIdleDelay.Location = new System.Drawing.Point(124, 143);
        	...
        	// numIdleNoF
        	// 
        	this.numIdleNoF.Location = new System.Drawing.Point(62, 49);
        	...
        	// numIdleFPS
        	// 
        	this.numIdleFPS.Location = new System.Drawing.Point(117, 49);
        	...
        	// numAttackingNoF
        	// 
        	this.numAttackingNoF.Location = new System.Drawing.Point(62, 73);
        	...
        	// numWalkingNoF
        	// 
        	this.numWalkingNoF.Location = new System.Drawing.Point(62, 97);
        	...
        	// numAttackingFPS
        	// 
        	this.numAttackingFPS.Location = new System.Drawing.Point(117, 73);
        	...
        	// numWalkingFPS
        	// 
        	this.numWalkingFPS.Location = new System.Drawing.Point(117, 97);
        	...
        	// btnIdlePlay
        	// 
        	this.btnIdlePlay.Location = new System.Drawing.Point(170, 47);
        	...
        	// btnAttackingPlay
        	// 
        	this.btnAttackingPlay.Location = new System.Drawing.Point(170, 71);
        	...
        	// btnWalkingPlay
        	// 
        	this.btnWalkingPlay.Location = new System.Drawing.Point(170, 95);
        	...
        	// gbActor
        	// 
        	this.gbActor.Controls.Add(this.label15);
        	this.gbActor.Controls.Add(this.btnDeathPlay);
        	this.gbActor.Controls.Add(this.numDeathNoF);
        	this.gbActor.Controls.Add(this.numDeathFPS);
        	...
        	// btnDeathPlay
        	// 
        	this.btnDeathPlay.Location = new System.Drawing.Point(170, 117);
        	this.btnDeathPlay.Name = "btnDeathPlay";
        	this.btnDeathPlay.Size = new System.Drawing.Size(34, 23);
        	this.btnDeathPlay.TabIndex = 43;
        	this.btnDeathPlay.Text = "play";
        	this.btnDeathPlay.UseVisualStyleBackColor = true;
        	this.btnDeathPlay.Click += new System.EventHandler(this.BtnDeathPlayClick);
        	// 
        	// numDeathNoF
        	// 
        	this.numDeathNoF.Location = new System.Drawing.Point(62, 119);
        	this.numDeathNoF.Minimum = new decimal(new int[] {
        	        	        	1,
        	        	        	0,
        	        	        	0,
        	        	        	0});
        	this.numDeathNoF.Name = "numDeathNoF";
        	this.numDeathNoF.Size = new System.Drawing.Size(40, 20);
        	this.numDeathNoF.TabIndex = 41;
        	this.numDeathNoF.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
        	this.numDeathNoF.Value = new decimal(new int[] {
        	        	        	1,
        	        	        	0,
        	        	        	0,
        	        	        	0});
        	this.numDeathNoF.ValueChanged += new System.EventHandler(this.NumDeathNoFValueChanged);
        	// 
        	// numDeathFPS
        	// 
        	this.numDeathFPS.Location = new System.Drawing.Point(117, 119);
        	this.numDeathFPS.Maximum = new decimal(new int[] {
        	        	        	60,
        	        	        	0,
        	        	        	0,
        	        	        	0});
        	this.numDeathFPS.Minimum = new decimal(new int[] {
        	        	        	1,
        	        	        	0,
        	        	        	0,
        	        	        	0});
        	this.numDeathFPS.Name = "numDeathFPS";
        	this.numDeathFPS.Size = new System.Drawing.Size(40, 20);
        	this.numDeathFPS.TabIndex = 42;
        	this.numDeathFPS.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
        	this.numDeathFPS.Value = new decimal(new int[] {
        	        	        	1,
        	        	        	0,
        	        	        	0,
        	        	        	0});
        	this.numDeathFPS.ValueChanged += new System.EventHandler(this.NumDeathFPSValueChanged);
        	// 
        	// label14
        	// 
        	...
        	// btnIdleLoop
        	// 
        	this.btnIdleLoop.Location = new System.Drawing.Point(207, 47);
        	...
        	((System.ComponentModel.ISupportInitialize)(this.numDeathNoF)).EndInit();
        	((System.ComponentModel.ISupportInitialize)(this.numDeathFPS)).EndInit();
        	this.groupBox1.ResumeLayout(false);
        	this.groupBox1.PerformLayout();
        	this.ResumeLayout(false);
        	this.PerformLayout();
        }
        private System.Windows.Forms.NumericUpDown numDeathFPS;
        private System.Windows.Forms.NumericUpDown numDeathNoF;
        private System.Windows.Forms.Button btnDeathPlay;
