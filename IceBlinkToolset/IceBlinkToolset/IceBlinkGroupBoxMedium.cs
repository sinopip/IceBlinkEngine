...
{
    public class IceBlinkGroupBoxMedium : System.Windows.Forms.GroupBox
    {
        ...
        public IceBlinkGroupBoxMedium()
        {            
            this.Text = "";
            this.TextIB = "iceBlinkGBMedium1";
            this.HeaderImage = global::IceBlinkToolset.Properties.Resources.gb_med_header;
        ...
        private void loadHeaderImage(Game game)
        {
            try
            {
                if (game.module != null)
                {
                    if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleGroupBoxMediumImage))
                    {
                        this.HeaderImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleGroupBoxMediumImage);
                    }
                    else
                    {
                        this.HeaderImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\gb_med_header.png");
                    }
                }
                else
                {
