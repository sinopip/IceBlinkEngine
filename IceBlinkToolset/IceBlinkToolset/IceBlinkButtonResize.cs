   ...
   public  class IceBlinkButtonResize : System.Windows.Forms.Button
    {
       ...
       public IceBlinkButtonResize()
       {
           ...
           this.BackgroundImage = global::IceBlinkToolset.Properties.Resources.b_rsize_normal;
           ...
           this.HoverImage = global::IceBlinkToolset.Properties.Resources.b_rsize_normal;
           this.Name = "iceBlinkButtonRArrow1";
           this.NormalImage = global::IceBlinkToolset.Properties.Resources.b_rsize_normal;
           this.PressedImage = global::IceBlinkToolset.Properties.Resources.b_rsize_normal;
       ...
       private void loadButtonImages(Game game)
       {
           try
           {
               if (game.module != null)
               {
                   if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonResizeNormalImage))
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonResizeNormalImage);
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonResizeHoverImage);
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonResizeNormalImage);
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonResizePressedImage);
                   }
                   else
                   {
