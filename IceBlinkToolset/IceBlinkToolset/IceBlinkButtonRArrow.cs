...
{
   public  class IceBlinkButtonRArrow : System.Windows.Forms.Button
    {
       //private Game game;
       ...
       public IceBlinkButtonRArrow()
       {
           ...
           this.BackgroundImage = global::IceBlinkToolset.Properties.Resources.b_rarw_normal;
           ...
           this.HoverImage = global::IceBlinkToolset.Properties.Resources.b_rarw_normal;
           this.Name = "iceBlinkButtonRArrow1";
           this.NormalImage = global::IceBlinkToolset.Properties.Resources.b_rarw_normal;
           this.PressedImage = global::IceBlinkToolset.Properties.Resources.b_rarw_normal;
       ...
       private void loadButtonImages(Game game)
       {
           try
           {
               if (game.module != null)
               {
                   if (File.Exists(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonRArrowNormalImage))
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonRArrowNormalImage);
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonRArrowHoverImage);
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonRArrowNormalImage);
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\modules\\" + game.module.ModuleFolderName + "\\ui\\" + game.module.moduleButtonRArrowPressedImage);
                   }
                   else
                   {
                       this.BackgroundImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_rarw_normal.png");
                       this.HoverImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_rarw_hover.png");
                       this.NormalImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_rarw_normal.png");
                       this.PressedImage = (Image)new Bitmap(game.mainDirectory + "\\data\\ui\\b_rarw_pressed.png");
                   }
               }
               else
               {
