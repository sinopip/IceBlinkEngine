...
namespace IceBlinkToolset
{
    ...
    { 
        ...
        {            
            ...
            string filenameOnly = ce_mod.ModuleConvosList[prntForm._selectedLbxConvoIndex] + ".xml";
            string dirFullPath = prntForm._mainDirectory + "\\modules\\" + ce_mod.ModuleFolderName + "\\dialog";
        ...
        private void tsAddNode_Click(object sender, EventArgs e)
        {
            ...
            /*try
            {
                ...
                if (!chdnod.isLink)
                {
                    ...
                    if (f_convo.GetContentNodeById(pnod).pcNode == true)
                    {
                    ...
                    f_convo.GetContentNodeById(pnod).AddNodeToSubNode(newNode);

                    refreshTreeView();
                }
            }
            catch { MessageBox.Show("add node failed"); }*/
        }        
        ...
        private void tsPasteNodes_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                catch { MessageBox.Show("paste node failed"); }
            }*/
        }        
        ...
        private void btnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.InitialDirectory = prntForm._mainDirectory + "\\modules\\" + ce_mod.ModuleFolderName + "\\graphics\\dialog";
        ...
        private void openFileDlg_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.InitialDirectory = prntForm._mainDirectory + "\\modules\\" + ce_mod.ModuleFolderName + "\\dialog";
        ...
        public void saveConvoFile()
        {
            try
            {
                f_convo.SaveContentConversation(prntForm._mainDirectory + "\\modules\\" + ce_mod.ModuleFolderName + "\\dialog\\" + ce_filename);
            }
            catch (Exception ex)
            {
        ...
        private void openFile(string filenameFullPath)
        {
            try
            {
                f_convo = f_convo.GetConversation(filenameFullPath);
                refreshTreeView();
            }
            catch (Exception ex)
            {
        ...
        private void setupConditionsDataGridView()
        {
            ...
            columnC.DataPropertyName = "c_script";
            columnC.HeaderText = "Script";
            columnC.Name = "c_script";
            columnC.Width = 150;
            columnC.ReadOnly = true;*/
        ...
        private void setupActionsDataGridView()
        {
            ...
            /*DataGridViewColumn columnC = new DataGridViewTextBoxColumn();
            columnC.DataPropertyName = "a_script";
            columnC.HeaderText = "Script";
            columnC.Name = "a_script";
            columnC.Width = 150;*/
        ...
        private void loadScriptText(string scriptFilename)
        {
            ...
            if (prntForm.mod.ModuleName != "NewModule")
            {
                if (File.Exists(prntForm._mainDirectory + "\\modules\\" + prntForm.mod.ModuleFolderName + "\\scripts\\" + scriptFilename))
                {
                    jobDir = prntForm._mainDirectory + "\\modules\\" + prntForm.mod.ModuleFolderName + "\\scripts";
                }
                else if (File.Exists(prntForm._mainDirectory + "\\data\\scripts\\" + scriptFilename))
                {
        ...
        {
            int node = Convert.ToInt32(treeView1.SelectedNode.Name);
            IceBlinkCore.Action newAction = new IceBlinkCore.Action();
